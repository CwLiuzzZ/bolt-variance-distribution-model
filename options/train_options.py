...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--data_annotation_path', type=str, default='./dataset/defect/train/train.txt', help='# choose data annotation for dataloader')
        self.parser.add_argument('--valid_data_annotation_path', type=str, default='./dataset/defect/train/valid.txt', help='# choose data annotation for valid dataloader')
